  ...
  <div class="container">
    ...
    <div class="navbar-collapse collapse" id="navbar-collapsible">
      <ul class="nav navbar-nav navbar-left">
        ...
        <li><a href="#section4">Disclaimer</a></li>
        <li>&nbsp;</li>
      </ul>
...
<section class="container-fluid" id="section1">
  	<h1 class="text-center v-center">Online UAV log management</h1>
 	
  	<div class="container">
      <div class="row">
          <div class="col-sm-12">
            <div class="row">
              <div class="col-sm-10 col-sm-offset-2 text-center"><p>Techlog is a cloud based platform for UAV personnel and log management</p><a class="btn btn-primary">Get Started</a></div>
            </div>
          </div>
      </div><!--/row-->
